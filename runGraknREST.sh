...
graql.sh -k SNB -f $SCRIPTPATH/./graql/ldbc-snb-1-resources.gql -r $REMOTE_PATH
graql.sh -k SNB -f $SCRIPTPATH/./graql/ldbc-snb-2-relations.gql -r $REMOTE_PATH
graql.sh -k SNB -f $SCRIPTPATH/./graql/ldbc-snb-3-entities.gql -r $REMOTE_PATH
